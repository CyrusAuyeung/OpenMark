...
![OpenMark v0.5 workspace with document sidebar, Markdown editor, search results, table controls, split preview, and status bar](docs/assets/openmark-screenshot.png)
...
![OpenMark v0.5 工作区：文档侧栏、Markdown 编辑器、搜索结果、表格控件、分屏预览和状态栏](docs/assets/openmark-screenshot.png)
