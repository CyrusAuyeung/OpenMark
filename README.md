...
[![Release version](https://img.shields.io/badge/release-v0.23.0-2f7a5f)](https://github.com/CyrusAuyeung/OpenMark/releases/tag/v0.23.0)
...
| Platform | Package |
| --- | --- |
| Windows installer | `OpenMark.Setup.0.23.0.exe` |
| Windows portable app | `OpenMark.0.23.0.exe` |
...
- Searchable recent files, workspace folder browsing, workspace content search, unified quick open, and keyboard-friendly library lists
...
| 平台 | 安装包 |
| --- | --- |
| Windows 安装版 | `OpenMark.Setup.0.23.0.exe` |
| Windows 便携版 | `OpenMark.0.23.0.exe` |
| macOS Intel | `OpenMark-0.23.0.dmg` |
| macOS Apple Silicon | `OpenMark-0.23.0-arm64.dmg` |
| Linux Debian/Ubuntu | `openmark-editor_0.23.0_amd64.deb` |
...
- 可搜索最近文件、浏览本地工作区文件夹、搜索工作区正文、统一快速打开，以及适合键盘操作的文件库列表
