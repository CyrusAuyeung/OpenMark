...
[![Release version](https://img.shields.io/badge/release-v0.21.1-2f7a5f)](https://github.com/CyrusAuyeung/OpenMark/releases/tag/v0.21.1)
...
| Platform | Package |
| --- | --- |
| Windows installer | `OpenMark.Setup.0.21.1.exe` |
| Windows portable app | `OpenMark.0.21.1.exe` |
...
| 平台 | 安装包 |
| --- | --- |
| Windows 安装版 | `OpenMark.Setup.0.21.1.exe` |
| Windows 便携版 | `OpenMark.0.21.1.exe` |
| macOS Intel | `OpenMark-0.21.1.dmg` |
| macOS Apple Silicon | `OpenMark-0.21.1-arm64.dmg` |
| Linux Debian/Ubuntu | `openmark-editor_0.21.1_amd64.deb` |
