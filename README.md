...
[![Release version](https://img.shields.io/badge/release-v0.18.1-2f7a5f)](https://github.com/CyrusAuyeung/OpenMark/releases/tag/v0.18.1)
...
| Platform | Package |
| --- | --- |
| Windows installer | `OpenMark.Setup.0.18.1.exe` |
| Windows portable app | `OpenMark.0.18.1.exe` |
| macOS Intel | `OpenMark-0.18.1.dmg` |
| macOS Apple Silicon | `OpenMark-0.18.1-arm64.dmg` |
| Linux Debian/Ubuntu | `openmark-editor_0.18.1_amd64.deb` |
...
| 平台 | 安装包 |
| --- | --- |
| Windows 安装版 | `OpenMark.Setup.0.18.1.exe` |
| Windows 便携版 | `OpenMark.0.18.1.exe` |
| macOS Intel | `OpenMark-0.18.1.dmg` |
| macOS Apple Silicon | `OpenMark-0.18.1-arm64.dmg` |
| Linux Debian/Ubuntu | `openmark-editor_0.18.1_amd64.deb` |
