...
| Platform | Package |
| --- | --- |
| Windows installer | `OpenMark.Setup.0.5.0.exe` |
| Windows portable app | `OpenMark.0.5.0.exe` |
| macOS Intel | `OpenMark-0.5.0.dmg` |
| macOS Apple Silicon | `OpenMark-0.5.0-arm64.dmg` |
| Linux Debian/Ubuntu | `openmark-editor_0.5.0_amd64.deb` |
...
- HTML/PDF export and Markdown/HTML clipboard copy from the toolbar, command palette, and desktop menu
...
| 平台 | 安装包 |
| --- | --- |
| Windows 安装版 | `OpenMark.Setup.0.5.0.exe` |
| Windows 便携版 | `OpenMark.0.5.0.exe` |
| macOS Intel | `OpenMark-0.5.0.dmg` |
| macOS Apple Silicon | `OpenMark-0.5.0-arm64.dmg` |
| Linux Debian/Ubuntu | `openmark-editor_0.5.0_amd64.deb` |
...
- 通过工具栏、命令面板和桌面菜单导出 HTML/PDF，或复制 Markdown/HTML 到剪贴板
