...
[![Release version](https://img.shields.io/badge/release-v0.7.0-2f7a5f)](https://github.com/CyrusAuyeung/OpenMark/releases/tag/v0.7.0)
...
| Platform | Package |
| --- | --- |
| Windows installer | `OpenMark.Setup.0.7.0.exe` |
| Windows portable app | `OpenMark.0.7.0.exe` |
| macOS Intel | `OpenMark-0.7.0.dmg` |
| macOS Apple Silicon | `OpenMark-0.7.0-arm64.dmg` |
| Linux Debian/Ubuntu | `openmark-editor_0.7.0_amd64.deb` |
...
| 平台 | 安装包 |
| --- | --- |
| Windows 安装版 | `OpenMark.Setup.0.7.0.exe` |
| Windows 便携版 | `OpenMark.0.7.0.exe` |
| macOS Intel | `OpenMark-0.7.0.dmg` |
| macOS Apple Silicon | `OpenMark-0.7.0-arm64.dmg` |
| Linux Debian/Ubuntu | `openmark-editor_0.7.0_amd64.deb` |
