...
const en = {
  ...
  commands: {
    ...
    quickOpenWorkspaceFile: 'Quick open workspace file',
  ...
  workspace: {
    ...
    quickOpenPlaceholder: 'Search workspace files',
    quickOpenSearch: 'Search workspace files',
    quickOpenResults: 'Workspace file results',
...
const zhCN: TranslationCatalog = {
  ...
  commands: {
    ...
    quickOpenWorkspaceFile: '快速打开工作区文件',
  ...
  workspace: {
    ...
    refresh: '刷新',
    quickOpen: '快速打开',
    quickOpenPlaceholder: '搜索工作区文件',
    quickOpenSearch: '搜索工作区文件',
    quickOpenResults: '工作区文件结果',
    searchFiles: '搜索工作区文件',
