...
- `OpenMark.Setup.0.7.0.exe`
- `OpenMark.0.7.0.exe`
- `OpenMark.Setup.0.7.0.exe.blockmap`

Expected macOS artifacts:

- `OpenMark-0.7.0.dmg`
- `OpenMark-0.7.0-arm64.dmg`
- `OpenMark-0.7.0-mac.zip`
- `OpenMark-0.7.0-arm64-mac.zip`

Expected Linux artifacts:

- `openmark-editor_0.7.0_amd64.deb`
...
- Enter a tag like `v0.7.0` to publish a GitHub release from the workflow run. The tag is validated as semantic version style and points at the workflow commit.
